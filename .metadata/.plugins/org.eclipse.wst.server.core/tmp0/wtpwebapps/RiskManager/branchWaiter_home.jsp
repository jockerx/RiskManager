...
<%
	Waiter waiter = (Waiter) ServletActionContext.getRequest().getSession().getAttribute("waiter");
%>
<!--bootstrap-->
					...
					<nav class="navbar navbar-default">
						...
						<div class="collapse navbar-collapse"
							...
							<ul class="nav navbar-nav">
								...
								<li><a href="branchWaiter_query.jsp">QUERYMEMBERINFO</a></li>
		...
		<div class="container">
			<div class="products-gallery">
				...
				<div class="col-md-8 arr">
					<form action="Sale">
						请输入会员卡号 <input type="text" class="form-control" placeholder=""
							name="mid" style="margin: 20px 0px; width: 750px;">
						请输入商品id <input type="text" class="form-control" placeholder=""
							name="pid" style="margin: 20px 0px; width: 750px;"> 请输入数量
						<input type="text" class="form-control" placeholder="" name="num"
							style="margin: 20px 0px; width: 750px;">请输入总价 <input
							type="text" class="form-control" placeholder="" name="total"
							style="margin: 20px 0px; width: 750px;">请输入支付方式 <input
							type="text" class="form-control" placeholder="会员卡1 现金2"
							name="type" style="margin: 20px 0px; width: 750px;">
