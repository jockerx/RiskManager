					...
					<nav class="navbar navbar-default">
						...
						<div class="collapse navbar-collapse"
							...
							<ul class="nav navbar-nav">
								...
								<li><a class="active" href="headquartersWaiter_addPlan.jsp">UPLOADPLAN</a></li>
								<li><a href="#">MODIFYREJECTEDPLAN</a></li>
								<li><a href="#">DELETEPLAN</a></li>
	...
	<div class="our-products" style="border-top: 3px solid pink;">
		<div class="container">
			<div class="products-gallery">
				<h2>UPLOAD NEW PRODUCTPLAN</h2>
				<div class="col-md-2 arr">
				</div>
				<div class="col-md-8 arr">
					<form action="addPlan">
							请输入名称 <input type="text" class="form-control" placeholder=""
								name="name"
								style="margin: 20px 0px; width: 750px;"> 请输入店铺id <input
								type="text" class="form-control" placeholder="" name="store_id"
								
								style="margin: 20px 0px; width: 750px;"> 请输入销售数量 <input
								type="text" class="form-control" placeholder="" name="num"
								
								style="margin: 20px 0px; width: 750px;">请输入单价 <input
								type="text" class="form-control" placeholder="" name="price"
							
								style="margin: 20px 0px; width: 750px;">请输入类型 <input
								type="text" class="form-control" placeholder="" name="type"
								
								style="margin: 20px 0px; width: 750px;">
							<button type="submit" class="btn btn-primary" style="float:right;margin: 20px 260px;padding: 20px 100px;">确定</button>
					</form>
				</div>
				<div class="clearfix"></div>
			</div>
